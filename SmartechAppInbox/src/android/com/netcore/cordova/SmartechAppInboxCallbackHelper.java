...
public class SmartechAppInboxCallbackHelper {


    public static void callbackSuccess(CallbackContext callbackContext, JSONArray response) {
        if (response == null) // in case there are no data
    ...
    public static void callbackSuccess(CallbackContext callbackContext, Integer value) {
    ...
    public static void callbackSuccess(CallbackContext callbackContext, boolean param) {
